<template>
    <fieldset>
        <div v-for="(val, index) in items" :key="index" class="form-group flex -mx-2">
            <div class="px-2">
            ...
            <div class="px-2">
                ...
                <input name="values[step][]" id="step" type="number" class="form-control" v-model="val.step" required>
            </div>
            <div class="px-2">
            ...
            <div class="px-2">
                ...
                <input name="values[max][]" id="max" type="number" class="form-control" step="0.1" v-model="val.max">
            </div>
